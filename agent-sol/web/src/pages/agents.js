          ...
          <tbody>
            ${tokens.map(t => `
              <tr style="border-bottom:1px solid rgba(255,255,255,0.04);cursor:pointer" class="token-row" data-token-id="${t.id}">
                <td style="padding:10px"><strong>${t.agent_name || 'Unknown'}</strong>${t.status === 'graduated' ? ' <span style="font-size:12px;color:#14F195" title="Graduated to Raydium"><img class="icon" src="/icons/white/rocket.png" alt="Graduated"></span>' : ''}</td>
        ...
        <div class="card glass mt-1" style="background:rgba(0,0,0,0.3);border-color:rgba(255,255,255,0.05);">
          ...
          ${token.status === 'graduated' ? `
            <div class="flex items-center" style="justify-content:space-between;">
              ...
              <span class="text-xs" style="color:#14F195;"><img class="icon" src="/icons/white/rocket.png" alt="Graduated"> Graduated</span>
            </div>
