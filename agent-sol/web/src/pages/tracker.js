  ...
  container.innerHTML = `
    ...
    <div class="section-header" style="margin-bottom: 1.5rem;">
      <h1 class="page-title" style="font-size: 2rem;">
        <span style="color: var(--green);"><img class="icon" src="/icons/white/chart.png" alt="Chart"></span> Token Tracker
      </h1>
...
function renderTable(tokens) {
  ...
  tbody.innerHTML = tokens.map((token, i) => {
    ...
    const statusBadge = status === 'graduated'
      ? '<span style="color: #9945FF; font-size: 0.8rem;"><img class="icon" src="/icons/white/rocket.png" alt="Graduated"> Raydium</span>'
  ...
  try {
    ...
    content.innerHTML = `
      ...
      <div class="card mb-2" style="padding: 0.75rem; text-align:center;">
        <span style="color:#14F195;font-weight:600"><img class="icon" src="/icons/white/rocket.png" alt="Graduated"> Graduated to Raydium CPMM</span>
      </div>
      `}
