        ...
        <div class="wizard-panel" id="step-1">
          ...
          <div class="mb-2">
            ...
            <div class="flex gap-1 mt-1" style="flex-wrap: wrap;">
              ...
              <button class="btn btn-sm btn-ghost template-btn" data-template="Research [topic] and produce a structured report with sources. Include key findings, trends, and actionable insights."><img class="icon" src="/icons/white/search.png" alt="Search"> Research</button>
